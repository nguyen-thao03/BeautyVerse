...
import {
  ...
  IonCard,
  IonImg,
  IonThumbnail, IonText, IonCol, IonRow, IonList, IonListHeader, IonItemGroup, IonFooter, IonModal, IonItemDivider } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonItemDivider, IonModal, IonFooter, IonItemGroup, IonListHeader, IonList, IonRow, IonCol, IonText, 
    IonImg,
    IonCard,
    IonIcon,
    IonButton,
